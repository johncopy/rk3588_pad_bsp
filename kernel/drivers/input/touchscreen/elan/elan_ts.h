...
struct elan_ts_data {
	...
	spinlock_t
		irq_lock_flag; /*irq enable/disable flage, 1=>irq has been disable, 0=>has been enable*/
	struct mutex
		irq_mutex; /* Guards against concurrent access to the irq_lock_flag*/
	bool irq_disabled;
	int elan_swapbit; /*lcm & tp coordinate match*/
	int gesture_mode; /*for gesture_mode flag*/
};
...
enum elan_fwid_fwver_addr {
	FW_ID_ADDR = 0xD5EA, //0x1FE66,	//for elan_IC 6Axx
	FW_VER_ADDR = 0xD1DE, //0x9E,
};
