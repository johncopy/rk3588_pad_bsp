...
# snd-aloop
sudo mkdir -p $TARGET_ROOTFS_DIR/lib/modules/5.10.209/kernel/sound/drivers/
sudo cp ../kernel/sound/drivers/snd-aloop.ko $TARGET_ROOTFS_DIR/lib/modules/5.10.209/kernel/sound/drivers/
...
chmod 0644 /etc/logrotate.d/rsyslog

chmod 0644 /etc/NetworkManager/system-connections/*
chmod 0644 /etc/udev/rules.d/70-net-persistent.rules
...
#---------------QT5--------------
#\${APT_INSTALL} /packages/qt5/*.deb

#---------------GHT--------------
\${APT_INSTALL} libxml2 libnsl2 default-libmysqlclient-dev default-mysql-client binutils rsync
...
#------------------xfce4 component------------
echo -e "\033[36m Install xfce4 component.................... \033[0m"
\${APT_INSTALL} xfce4-notifyd xfce4-goodies

#------------------audio/video app------------
echo -e "\033[36m Install audio and video app.................... \033[0m"
\${APT_INSTALL} guvcview audacity parole

#------------------fcitx5------------
echo -e "\033[36m Install fcitx5.................... \033[0m"
\${APT_INSTALL} im-config zenity
\${APT_INSTALL} fcitx5 fcitx5-chinese-addons fcitx5-frontend-gtk2 fcitx5-frontend-gtk3 fcitx5-frontend-qt5 fcitx5-config-qt fcitx5-rime
...
cat << UDEV_RULE > /etc/udev/rules.d/99-input.rules
KERNEL=="event*", NAME="input/%k", MODE="660", GROUP="input"
UDEV_RULE
# add linaro to group input
usermod -a -G input linaro
...
sudo cp -rf overlay-last/* $TARGET_ROOTFS_DIR/

#最后阶段修改文件系统内容脚本
##add by john at 2016.1.19 
sudo mv $TARGET_ROOTFS_DIR/usr/bin/pavucontrol $TARGET_ROOTFS_DIR/usr/bin/pavucontrol.bak

echo "finsh overlay-last"
